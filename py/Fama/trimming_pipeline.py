...
def trimming_pipeline(config_file, sequence_list_file, project_name, collection, is_protein):
    ...
    # run Trimmomatic, if not protein
    ...
    # save project.ini
    project_ini_path = os.path.join(working_directory, 'project.ini')
