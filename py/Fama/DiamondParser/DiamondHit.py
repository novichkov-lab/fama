class DiamondHit(object):
    ...
    def create_hit(self, tabular_output_fields):
        """Fills DiamondHit attributes with values from DIAMOND output in tabular format
        
        Args:
            tabular_output_fields (list): list of values for 10 fields of DIAMOND output in tabular format
